...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.question.subquestions, function (subquestion, i) {
            ...
            (_ctx.question.mask)
              ? (openBlock(), createBlock(_component_the_mask, {
                  ...
                  onKeyup: [
                    ...
                    withKeys(withModifiers(function ($event) { return ($options.onCompositeEnter(subquestion.id)); }, ["prevent"]), ["enter"]),
                    withKeys(withModifiers(function ($event) { return ($options.onCompositeEnter(subquestion.id)); }, ["prevent"]), ["tab"])
                  ],
                  onFocus: _ctx.setFocus,
                  onBlur: _ctx.unsetFocus,
